    ...
    UpdateHandler.prototype.startHandler = function (saveCreds) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                this.client.ev.on('connection.update', function (update) {
                            ...
                            switch (_g.label) {
                                case 0:
                                    ...
                                    if (!(connection === 'close'))
                                        return [3 /*break*/, 2];
                                    console.log(
                                        '\u0421\u043E\u0435\u0434\u0438\u043D\u0435\u043D\u0438\u0435 \u0437\u0430\u043A\u0440\u044B\u0442\u043E \u0438\u0437 \u0437\u0430 '
                                            .concat(
                                                (_a =
                                                    lastDisconnect === null ||
                                                    lastDisconnect === void 0
                                                        ? void 0
                                                            ...
                                                            function (_a) {
                                                                switch (
                                                                    ...
                                                                    case 0:
                                                                        return [
                                                                            4 /*yield*/,
                                                                            new MessageHandler_1.MessageHandler(
                                                                                this.client
