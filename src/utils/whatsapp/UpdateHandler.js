...
var UpdateHandler = /** @class */ (function (_super) {
    ...
    function UpdateHandler(_client, _saveCreds) {
        var _this = _super.call(this) || this;
        _this.client = _client;
        _this.saveCreds = _saveCreds;
        return _this;
    }
    UpdateHandler.prototype.saveQr = function (qr) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                (0, qrcode_1.toFile)(this.codeSavePath, [{ data: qr, mode: 'string' }]);
    ...
    UpdateHandler.prototype.reconnect = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, new WhastApp_1.WhatsApp().connectToWhatsApp()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    UpdateHandler.prototype.startHandler = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                ...
                this.client.ev.on('connection.update', function (update) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_g) {
                        ...
                        if (connection == 'open') {
                            if (_super.prototype.isRegister) {
                                console.log(0);
